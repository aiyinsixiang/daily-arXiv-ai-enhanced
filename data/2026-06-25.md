...
### [1] [A Contactless Heat Engine Driven by Nonreciprocal Fluctuation-Induced Torques](https://arxiv.org/abs/2606.25053)
...
### [2] [Exact Leg-Cut Influence Functional and Emergence of Gaussian Entanglement Theory in a Statistical-Dressing Ladder Model](https://arxiv.org/abs/2606.25669)
...
### [3] [Nonlocal Quantum Phase Transitions](https://arxiv.org/abs/2606.25061)
...
### [5] [Long-lasting Topological Entanglement in a Monitored Rashba Nanowire](https://arxiv.org/abs/2606.25653)
...
### [6] [Majorana-Pauli stabilizer codes and duality webs of fermionic topological phases](https://arxiv.org/abs/2606.25048)
...
### [7] [Many-Body Second Order Green's Function Theory for Ab Initio Molecular Quantum Electrodynamics](https://arxiv.org/abs/2606.26076)
...
### [8] [Constraint-Aware Quantum Optimization of Defect Configurations in Doped ZrO2: XY-Mixer QAOA and Grover Adaptive Search](https://arxiv.org/abs/2606.24922)
*Huajing Song*
...
### [9] [Non-Abelian Anyon Braiding with Quantum-Antidot Interferometry](https://arxiv.org/abs/2606.24930)
...
### [10] [Local spectroscopy of anyons bound to charge traps](https://arxiv.org/abs/2606.25024)
...
### [11] [Real-space Imaging of Quantum Hall Quasiparticles](https://arxiv.org/abs/2606.25036)
...
### [12] [Layer-tunable Hubbard bands probed via moiré excitons in MoSe$_2$/WS$_2$ heterostructures](https://arxiv.org/abs/2606.25071)
...
### [13] [Defect Engineered 2D MoS2 Materials for ML-enabled Neurotransmitter SERS Detection](https://arxiv.org/abs/2606.25235)
...
### [14] [High-Performance Nanophononic Resonators in Self-Suspended WSe$_2$ Domes and Drums](https://arxiv.org/abs/2606.25946)
...
### [15] [Residual orbital magnetization governs the anomalous Hall effect in altermagnets](https://arxiv.org/abs/2606.25999)
...
### [18] [Quantum Back-Action Expands the Excitonic Hilbert Space in a Soft Polar Semiconductor](https://arxiv.org/abs/2606.26063)
...
### [19] [All-electrical dephasing-protected spin qubits in altermagnets](https://arxiv.org/abs/2606.26066)
...
### [20] [Strong photogalvanic effect in Weyl materials due to magnetic resonances](https://arxiv.org/abs/2606.26067)
...
### [21] [The SU(N) Holstein Model](https://arxiv.org/abs/2606.25240)
...
### [22] [Intrinsic Magnetic Excitations and Heavy-Fermion Formation in the Frustrated Mn Pyrochlore System YMn$_{2+δ}$Zn$_{20-x}X_x$ ($X$ = In and Al) Revealed by Nuclear Magnetic Resonance and Nuclear Quadrupole Resonance Measurements](https://arxiv.org/abs/2606.25242)
...
### [23] [Kohn anomaly in a topological phase transition](https://arxiv.org/abs/2606.25381)
...
### [24] [Spin-imbalanced fermion on a dynamic lattice](https://arxiv.org/abs/2606.25411)
...
### [25] [Automatic-differentiation-enabled dynamic parameter retrieval with sub-pulse-width resolution](https://arxiv.org/abs/2606.25479)
...
### [26] [Fractional phase slips across the charge-density-wave domain walls in 1-T TiSe2](https://arxiv.org/abs/2606.25963)
...
### [27] [Spin modulations in the Rashba-Hubbard chain -- a tensor network study](https://arxiv.org/abs/2606.26014)
...
### [28] [Folds of one curve: the superradiant phase diagram of Dicke modes with interacting matter](https://arxiv.org/abs/2606.26081)
*Max Hörmann*
...
### [29] [Higher Berry curvature, second Chern numbers and magnetoelectric coupling in crystalline insulators](https://arxiv.org/abs/2606.26096)
...
### [30] [Exactly solvable pair-density wave in topological flat bands from magnetic translation symmetries](https://arxiv.org/abs/2606.25038)
...
### [31] [NMR evidence for a loop-current state with broken $C_6$ symmetry in the charge-ordered CsV$_3$Sb$_5$](https://arxiv.org/abs/2606.25251)
...
### [32] [A Gauge-Theoretic Formulation of Nambu Non-equilibrium Thermodynamics](https://arxiv.org/abs/2606.24919)
*So Katagiri*
...
### [33] [A Minimal Active-Particle Realization of Non-Hermitian Chern Bulk-Boundary Correspondence](https://arxiv.org/abs/2606.24926)
...
### [34] [Accelerating Chemical Potential Calculations with Minimal Normalizing Flows](https://arxiv.org/abs/2606.25229)
...
### [35] [Dynamic dissipative structures in bistable magnetic ordered spin crossover systems: self-oscillations of magnetization](https://arxiv.org/abs/2606.25506)
...
### [36] [Lattice non-invertible symmetry from non-commuting transfer matrices](https://arxiv.org/abs/2606.25660)
...
### [37] [Macroscopic Fokker-Planck equation from microscopic Glauber dynamics for the Nagle-Kardar model](https://arxiv.org/abs/2606.25919)
...
### [38] [Real-Space Mapping of Electronic Conductivity in Complex Materials](https://arxiv.org/abs/2606.24914)
...
### [39] [Operando spectro-ptychography reveals dynamical charge-storage and degradation pathways in redox-active electrodes](https://arxiv.org/abs/2606.25175)
...
### [40] [Intrinsic Defect Energetics and Fluorine Doping Effects in Li2CO3 and Li2O2: A First-Principles Study](https://arxiv.org/abs/2606.25408)
...
### [41] [Spin-flip optical excitations in van der Waals antiferromagnet CrPS$_4$](https://arxiv.org/abs/2606.25470)
...
### [42] [A Differentiable DFT-Based Framework for Inverse Materials Design](https://arxiv.org/abs/2606.25502)
...
### [43] [A topology-tuned pressure valve across the isoreticular RHO zeolite family](https://arxiv.org/abs/2606.25557)
...
### [44] [Valence-change-driven reduction of antiphase boundaries in spinel ferrite epitaxial films](https://arxiv.org/abs/2606.25617)
...
### [45] [Rate Programmable Ionic-Redox Switching with Tunable Volatility in CuCrP2S6](https://arxiv.org/abs/2606.25679)
...
### [46] [Barocaloric phase transformation from data efficient fine-tuning of machine learned interatomic potentials](https://arxiv.org/abs/2606.25742)
...
### [47] [The interplay of interfaces, supramolecular assembly, and electronics in organic semiconductors](https://arxiv.org/abs/2606.25891)
...
### [48] [Thermoelectric response of a ferroelectric insulator](https://arxiv.org/abs/2606.25767)
...
### [49] [Spontaneous spin splitting and tunable valley polarization in a two-dimensional fully compensated ferrimagnet](https://arxiv.org/abs/2606.25843)
...
### [50] [Harnessing electrostatics through temperature modulations to control ferroelectrics](https://arxiv.org/abs/2606.25850)
...
### [51] [A Combined Tight Binding with Machine Learning Potential Model for Magnesium Compounds](https://arxiv.org/abs/2606.25853)
...
### [52] [Sensitivity-optimal coplanar waveguide design for broadband magnetic resonance spectroscopy: a Beer--Lambert framework](https://arxiv.org/abs/2606.25861)
...
### [53] [Orientation Mapping via Dictionary Indexing of AC-STEM Kikuchi patterns using Open-source Software](https://arxiv.org/abs/2606.25911)
...
### [54] [Impact of sintering conditions on the dielectric properties of TiO2 ceramics for metamaterialsapplications at terahertz frequencies](https://arxiv.org/abs/2606.25930)
...
### [55] [Capturing Nuclear Quantum Effects in Hydrogen Diffusion through MoS2 via Machine-Learning-Enhanced Path-Integral Simulations](https://arxiv.org/abs/2606.25991)
...
### [56] [Primary damage and mechanical degradation of WTaCrV refractory high-entropy alloy: effects of solid-solution and chemical ordering](https://arxiv.org/abs/2606.26019)
...
### [57] [Epitaxial Strain Activates Altermagnetic Spin-Splitting Torques in RuO2(100)](https://arxiv.org/abs/2606.26023)
