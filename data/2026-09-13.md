...
### [1] [Henstock--Kurzweil Gauge Integral in the Non--Gaussian Regime: A Machine--Verified Construction](https://arxiv.org/abs/2609.10793)
*Yuri N. Berdinsky*
...
### [2] [The kinematic structures and the inertial geometry of a moving charge](https://arxiv.org/abs/2609.11165)
...
### [3] [Recent Advances on a Model for the Electromagnetic Dirac Field at Thermal Equilibrium](https://arxiv.org/abs/2609.11283)
*Umberto Morellini*
...
### [4] [A proof of the Hodge universality conjecture at nonzero dispersion](https://arxiv.org/abs/2609.11469)
...
### [5] [Quantum Inversion of Units in Group Rings: Block Dimension, Not Commutativity, Governs Hardness](https://arxiv.org/abs/2609.10596)
*Bhanwar Gupta*
...
### [6] [Differential and Common Decoherence Modes in Witnessing the Quantum Gravity-Induced Entanglement of Matter](https://arxiv.org/abs/2609.10697)
...
### [7] [Perfect $(s,r)$-state transfer](https://arxiv.org/abs/2609.10713)
...
### [8] [Nonlinear dynamics and mechanical frequency combs with a Meissner-levitated micromagnet](https://arxiv.org/abs/2609.11668)
...
### [9] [On-chip squeezed light in the audio frequency band](https://arxiv.org/abs/2609.11004)
...
### [10] [Bargmann Invariants Are Insufficient for Complete Local-Unitary Orbit Discrimination](https://arxiv.org/abs/2609.11090)
*Lin Zhang,Bing Xie*
...
### [11] [Finite-blockade dynamics of a three-qubit ccz gate in neutral-atom arrays](https://arxiv.org/abs/2609.11159)
...
### [12] [Quantum Random Access Memory Implementation Using Photon-Photon Interaction in Rydberg Atomic Ensemble](https://arxiv.org/abs/2609.11333)
...
### [13] [From Analytic Structure to Quantum Complexity: Walsh-Pauli Representations of Continuum Operators](https://arxiv.org/abs/2609.11350)
...
### [14] [Optimizing quantum encodings for analog simulation through dynamical algebra reachability](https://arxiv.org/abs/2609.11351)
...
### [15] [Entanglement Meets Reality: A Network Engineering Assessment and Forecast of Rackable Entanglement Sources](https://arxiv.org/abs/2609.11387)
...
### [16] [The Quantum Composition Paradox](https://arxiv.org/abs/2609.11402)
*Jacob Biamonte*
...
### [17] [The Quantum Plumber's Problem](https://arxiv.org/abs/2609.11416)
...
### [18] [Self-guided certification of nonlocality in quantum networks](https://arxiv.org/abs/2609.11451)
...
### [19] [Local decoders for fault-tolerant quantum computation and translation-invariant stabilizer codes](https://arxiv.org/abs/2609.11457)
...
### [20] [Joint Mitigation of Algorithmic and Physical Errors in Noisy Hamiltonian Simulation](https://arxiv.org/abs/2609.11508)
...
### [21] [One-clean-qubit spectroscopy of simulated Kitaev chains](https://arxiv.org/abs/2609.11513)
...
### [22] [Impossible to conjugate an unknown quantum state via a unitary evolution](https://arxiv.org/abs/2609.11536)
*Dafa Li*
...
### [23] [Dissipative Quantum Battery from Many-Body Scars](https://arxiv.org/abs/2609.11595)
...
### [24] [Certifying Adversarial Robustness of Quantum Classifiers under Known-Readout Query Access](https://arxiv.org/abs/2609.11637)
...
### [25] [Lifted surgery: Fast processing with QLDPC codes](https://arxiv.org/abs/2609.11723)
...
### [26] [An exchange-assisted entangling gate between 87Rb and 171Yb Rydberg atoms](https://arxiv.org/abs/2609.11730)
...
### [27] [Learning structural balance of graphs from quantum spectral features](https://arxiv.org/abs/2609.11736)
...
### [28] [Absolutely Maximally Entangled States of $2q$ Parties in Every Odd Prime-Power Dimension $q$](https://arxiv.org/abs/2609.11796)
...
### [29] [The cost of simulating classically tractable quantum circuits and dynamics](https://arxiv.org/abs/2609.11847)
...
### [30] [PureSuperQMA(exp) = BellPureSymQMA(poly) = QMA via Dimension-Free Bosonic Argmax](https://arxiv.org/abs/2609.11854)
...
### [31] [EFI Pairs Without One-Way Puzzles: Oracle Separations from Communication Complexity](https://arxiv.org/abs/2609.11901)
*Atul Mantri*
...
### [32] [The generalised semi-Clifford conjecture is false](https://arxiv.org/abs/2609.11903)
...
### [34] [Dissipative quantum mechanics of Andreev bound states](https://arxiv.org/abs/2609.10691)
...
### [35] [Consensus in Effective Model Inference for Disordered Ising Systems](https://arxiv.org/abs/2609.10731)
*Ashveed Ashraf*
...
### [36] [Information-Theoretic Characterization of Macroscopic Chaos Emerging from the Chemical Master Equation](https://arxiv.org/abs/2609.11340)
...
### [37] [Disordered ground states in one-dimensional exactly solvable fluids](https://arxiv.org/abs/2609.11394)
...
### [39] [Work as a function of protocol duration for the efficient erasure of an underdamped memory: isothermal to adiabatic transition](https://arxiv.org/abs/2609.11473)
...
### [40] [Thermal Stability of Encapsulated Molecular Structures with Extended OH-Hydrogen-Bond Chains](https://arxiv.org/abs/2609.10777)
*Alexander V. Savin*
...
### [41] [Dissipation-induced nonlocal phase-coherent transport in a topological superconductor](https://arxiv.org/abs/2609.10821)
...
### [42] [Controlling topology in flux-mismatched Hofstadter bilayers](https://arxiv.org/abs/2609.10837)
...
### [43] [Emergence of spin-orbit coupling among spin, atomic orbital, and Bloch dynamics in Janus double-transition-metal MXenes](https://arxiv.org/abs/2609.10953)
*Tetsuro Habe*
...
### [44] [A substrate booster for P-type 2D ferromagnetic semiconductor](https://arxiv.org/abs/2609.11015)
...
### [45] [Bridging steady-state and time-domain descriptions of molecular electron transport](https://arxiv.org/abs/2609.11684)
...
### [46] [Fingerprints of Excitonic Collective Modes in the Two-Dimensional Electron Gas](https://arxiv.org/abs/2609.11138)
...
### [47] [Interacting Tomonaga-Lüttinger liquid with impurity for interaction constant $K = 1/2$: Thermopower investigation, entropy variation and heat capacity densities associated with thermoelectric particle transport](https://arxiv.org/abs/2609.11810)
...
### [48] [Geometric Ginzburg-Landau theory of charge ordering and commensurability](https://arxiv.org/abs/2609.10678)
...
### [49] [A Unified Theory of Collective Magnon and Orbiton Excitations in Altermagnets](https://arxiv.org/abs/2609.10708)
...
### [52] [Topological band structure of excitons in octochlore KTb$_{3}$F$_{10}$: an analog of the Luttinger Semimetal](https://arxiv.org/abs/2609.11466)
...
### [53] [Robust Spin-1 Haldane Topology under Itinerant Doping](https://arxiv.org/abs/2609.11591)
*Satoshi Nishimoto*
...
### [54] [Block entropy area based non-local fermionic mode optimization with gradient disentanglers](https://arxiv.org/abs/2609.11811)
...
### [55] [Sub-cycle doublon-holon dynamics in one-dimensional Mott insulators revealed by two-color high-harmonic spectroscopy](https://arxiv.org/abs/2609.11858)
...
### [56] [Low temperature thermodynamics of $S_{\mathrm{eff}}=1/2$ triangular lattice quantum spin liquid candidate TlYbS$_2$](https://arxiv.org/abs/2609.11881)
...
### [57] [Effective Ionic Valence and Local Magnetic Moment in Kagome Superconductors](https://arxiv.org/abs/2609.11927)
...
### [58] [Moiré Topology in Twisted Structures with Noncollinear Spin-Orbit Coupling](https://arxiv.org/abs/2609.10720)
...
### [59] [On the physical origins of switching diversity in Cu-embedded SiO$_x$ memristive devices](https://arxiv.org/abs/2609.10799)
...
### [60] [Hyperspin Altermagnets](https://arxiv.org/abs/2609.10930)
...
### [61] [Measuring chiral phonons](https://arxiv.org/abs/2609.10973)
...
### [62] [A model of grain growth in UN integrating molecular dynamics, phase-field modeling, and uncertainty quantification](https://arxiv.org/abs/2609.10977)
...
### [63] [Silicon Solar Cell Design for >30% Efficiency via Singlet Fission](https://arxiv.org/abs/2609.10979)
...
### [64] [Vacancy Order and Physical Properties of a Ternary Compound Fe0.68Pd0.80Te with an α-Fe1+xTe-Type Structure](https://arxiv.org/abs/2609.11441)
...
### [65] [High-Performance Scaled P-Type SnOx Transistor by Atomic Layer Deposition with CFET Integration](https://arxiv.org/abs/2609.11114)
...
### [66] [Interplay of spin-lattice and electronic coupling far above Neel ordering in 2D antiferromagnetic CrPS4 and its interface manifestation](https://arxiv.org/abs/2609.11203)
...
### [67] [A Community-Developed Domain Ontology for Magnetic Materials](https://arxiv.org/abs/2609.11464)
...
### [68] [Competition between vacancy creation and filling in defect-engineering of hBN](https://arxiv.org/abs/2609.11666)
...
### [69] [High-throughput thermodynamic screening of oxide-scale adhesion across the CoCrFeMnNiAl high-entropy alloys](https://arxiv.org/abs/2609.11640)
...
### [70] [Piezomagnetism in a model cubic noncollinear altermagnet](https://arxiv.org/abs/2609.11816)
...
### [71] [High-fidelity k$\cdot$p representations of first-principles electronic band structures through covariant renormalization](https://arxiv.org/abs/2609.11861)
*Kristian Berland*
...
### [72] [High-Temperature ferromagnetism from site-selective filling in (Fe,Ni)$_{6-δ}$GeTe$_2$](https://arxiv.org/abs/2609.11862)
