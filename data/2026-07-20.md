...
### [10] [Conditional Euclidean-Hamiltonian reductions for sign-problem toy models](https://arxiv.org/abs/2607.15950)
*Tsogtgerel Gantumur*
...
### [11] [Structure-Agnostic Unitary Learning from Quantum Observable Dynamics with Application to Hamiltonian Identification](https://arxiv.org/abs/2607.15316)
*Mohamed Berkani*
...
### [12] [Fate of dynamical quantum phase transitions from sudden quench to slow quench limit](https://arxiv.org/abs/2607.15649)
...
### [13] [Collective Enhancement of Nuclear Excitation for a Nuclear Quantum Battery](https://arxiv.org/abs/2607.15319)
...
### [14] [Quantum Mechanics on Lie Groups: II. Path Integrals](https://arxiv.org/abs/2607.16029)
...
### [15] [Quantum error-correcting codes from aperiodic monotiles: the Hat and the Spectre](https://arxiv.org/abs/2607.15326)
...
### [16] [Quantum-classical crossover in fault-tolerant quantum dynamics simulation](https://arxiv.org/abs/2607.16116)
...
### [17] [Non-Hermitian Quantum Adiabatic Algorithm](https://arxiv.org/abs/2607.15343)
*Zi-Bo Jin,Yi Zhang*
...
### [18] [Causality from the spectrum: Emergence of causal order from process-matrix mereology](https://arxiv.org/abs/2607.15345)
...
### [19] [The Paradox of the Third Particle is classical](https://arxiv.org/abs/2607.15351)
...
### [20] [Spectral amplification for ground-state energy estimation of electronic structure in first quantization](https://arxiv.org/abs/2607.15358)
...
### [21] [The Trinity of Markovian Quantum Thermodynamics: Unifying the Axiomatic, Microscopic, and Operational Paradigms](https://arxiv.org/abs/2607.15376)
...
### [22] [Saturating the Bayesian Nagaoka-Hayashi bound within numerical precision for the depolarization SU(2) rotation channel](https://arxiv.org/abs/2607.15398)
...
### [23] [Boosting State Discrimination in Quantum Brownian Motion Channel via Memory-Induced Coherence Preservation](https://arxiv.org/abs/2607.15405)
...
### [24] [Performance Model for Hybrid Quantum-Classical Workflows](https://arxiv.org/abs/2607.15426)
...
### [25] [Generation and detection of squeezed light on a single silicon photonic chip](https://arxiv.org/abs/2607.15461)
...
### [26] [Efficient routing and spectrum allocation in arbitrary flex-grid entanglement networks](https://arxiv.org/abs/2607.15465)
...
### [27] [The Complexity of Dynamical Correlators: Operator Shadows and Exponential Learning Separations](https://arxiv.org/abs/2607.15493)
...
### [28] [Microscopic Side Information Controls Ordered Hayden--Preskill Recovery](https://arxiv.org/abs/2607.15537)
...
### [29] [Benchmarking Hybrid Quantum-Classical Algorithms for Power Grid Optimization Problems](https://arxiv.org/abs/2607.15543)
...
### [30] [Reconstruction of the noise correlation spectral density from the cavity emission in a two-qubit system](https://arxiv.org/abs/2607.15909)
...
### [31] [Quantum states supported by matroids](https://arxiv.org/abs/2607.15548)
...
### [32] [Agnostic learning of qudit stabilizer states](https://arxiv.org/abs/2607.15559)
...
### [33] [Deterministic atom-shuttle interconnects via ultrafast atom-ion entangling gate](https://arxiv.org/abs/2607.15597)
*Mu Qiao*
...
### [34] [Classical codes violate the conjectured square-root bound for quantum random access codes](https://arxiv.org/abs/2607.15617)
*Kangqiao Liu*
...
### [35] [Spectral Attack on Continuous-Variable Quantum Key Distribution Systems](https://arxiv.org/abs/2607.15668)
...
### [36] [Boundary-Phase Control of Sequentially Addressed Trapped-Ion ZZ Interactions](https://arxiv.org/abs/2607.15688)
...
### [37] [Non-Gaussianity in cat codes: global incompatibility and local geometric alignment with the magic resource](https://arxiv.org/abs/2607.15739)
...
### [38] [Grover's algorithm for image edge detection](https://arxiv.org/abs/2607.15744)
...
### [39] [Manipulating non-intrinsic outputs of a non-Hermitian coupled system by weak external driving](https://arxiv.org/abs/2607.15770)
...
### [40] [The Fourier Wall: Why Public Tabular Datasets Refuse Quantum Advantage, and a Certified Recipe for Where It Lives](https://arxiv.org/abs/2607.15815)
...
### [41] [Maximal quantum leakage: operational interpretation and quantum channel analysis](https://arxiv.org/abs/2607.15853)
...
### [42] [The statistical disturbance bound of quantum measurements](https://arxiv.org/abs/2607.15874)
...
### [43] [Alleviating the Sparse Matrix Scaling Bottleneck in Adaptive VQE via Greedy Operator Commutativity Partitioning and High-Order Taylor State Evolution](https://arxiv.org/abs/2607.15906)
...
### [44] [Optimization of multistate STIRAP by pulse shaping](https://arxiv.org/abs/2607.15915)
...
### [45] [Beyond the Positive Partial Transpose Squared Conjecture: The Qutrit Case](https://arxiv.org/abs/2607.15947)
...
### [46] [Parameter Estimation in a Continuously Monitored Non-Markovian Quantum System](https://arxiv.org/abs/2607.15978)
...
### [47] [Tunable Families of Multiqubit Elegant Joint Measurements](https://arxiv.org/abs/2607.16020)
...
### [60] [Fermion parity of an Andreev molecule probed by nonlocal Josephson effect](https://arxiv.org/abs/2607.15786)
...
### [61] [Drift-Induced Nonreciprocal Hyperbolic Polaritons in Graphene/$α$-MoO$_3$ Heterostructures](https://arxiv.org/abs/2607.15722)
...
### [70] [Spontaneous Nanopatterning and Strain Relaxation in SiGe Layers Grown by Oxidative Solid Phase Epitaxy](https://arxiv.org/abs/2607.15332)
...
### [71] [Phase-Field Simulation of Dendrite Evolution in All-Solid-State Sodium Batteries during Cycling](https://arxiv.org/abs/2607.15387)
...
### [72] [Ab initio time-dependent GW approach for nonequilibrium exciton-phonon coupled dynamics across momentum space](https://arxiv.org/abs/2607.15411)
...
### [73] [exa-PD: A scalable high-performance workflow for multi-element phase diagram construction](https://arxiv.org/abs/2607.15476)
...
### [74] [Exploring the Potential of BY3 (Y = P, As) Monolayers as High-Capacity and Rapid-Diffusion Anodes for Sodium-Ion Batteries](https://arxiv.org/abs/2607.15514)
...
### [75] [Symbolic Predicate-Guided Language Agents for Inverse Design of Perovskite Oxides](https://arxiv.org/abs/2607.15535)
...
### [76] [Terahertz Time-Domain Spectroscopy as a Universal Defect Fingerprinting Tool for Organic Halide Perovskite Solar Cells](https://arxiv.org/abs/2607.15538)
...
### [77] [Symmetry-Enforced Dirac Fermions and Structural Metastability in Pentagonal Monolayers of Transition-Metal Ditellurides](https://arxiv.org/abs/2607.15580)
...
### [78] [General and scalable vapor etching and transformation platform for two-dimensional materials](https://arxiv.org/abs/2607.15581)
...
### [79] [Interface-Engineered Giant Multistate Resistance Switching in Altermagnetic CrSb Multiferroic Tunnel Junctions](https://arxiv.org/abs/2607.15728)
...
### [80] [Two-step growth of (In,Ga)N pseudo-substrates on GaN templates by plasma-assisted molecular beam epitaxy](https://arxiv.org/abs/2607.15748)
...
### [81] [Nonuniform pressure helps structural superlubricity](https://arxiv.org/abs/2607.15967)
...
### [82] [Structural Relaxation Enables Millisecond Infrared Photodetection in Selenium Iodine Semiconductors](https://arxiv.org/abs/2607.16054)
*Biman Jana*
...
### [83] [Emergent Interfacial Magnetism in Epitaxial RuO$_2$](https://arxiv.org/abs/2607.16093)
...
### [84] [Subgrain-resolved Analysis of Degradation in Cu Metallization via Scanning 3DXRD and Thermomechanical Modeling](https://arxiv.org/abs/2607.16108)
...
### [85] [Atomistic mechanism of corrosion-induced grain boundary migration in NiCr alloys in molten FLiNaK](https://arxiv.org/abs/2607.16167)
...
### [86] [A Dynamical Phase-Field Model for the Optical Properties of Ferroelectrics](https://arxiv.org/abs/2607.16180)
...
### [87] [First-Order Topological FFLO Transition and Superconducting Diode Sign Reversal in Altermagnetic Nanowires](https://arxiv.org/abs/2607.15720)
...
### [88] [Contactless terahertz mapping of wafer-scale superconducting NbTiN thin films](https://arxiv.org/abs/2607.15757)
...
### [89] [Drosophila of phonon-mediated superconductivity: Full Eliashberg theory of the jellium model](https://arxiv.org/abs/2607.15996)
...
### [90] [Coherent driving of displacive Higgs fluctuations in superconductors](https://arxiv.org/abs/2607.16055)
...
### [91] [Metric tensors and two-forms in information geometry from the GNS construction](https://arxiv.org/abs/2607.15800)
...
### [92] [Variational modeling adapted to the medium with gradient properties](https://arxiv.org/abs/2607.16005)
...
### [93] [Inertial motion of incompressible continua](https://arxiv.org/abs/2607.16043)
...
### [94] [Path optimization method for the sign problem: Insights from random matrix models](https://arxiv.org/abs/2607.15742)
...
### [95] [Fragmented ETH: Prethermalization, Timescales, and Ensemble Inequivalence](https://arxiv.org/abs/2607.15350)
...
### [96] [Scaling regimes of the Kuramoto-Sivashinsky equation from the functional renormalization group](https://arxiv.org/abs/2607.15784)
...
### [97] [Ultrametric organization of energy landscapes on random Erdős--Rényi graphs: topological origin of barrier hierarchy](https://arxiv.org/abs/2607.15902)
*A. P. Zubarev*
...
### [98] [Zigzag ordering, defects, and anomalous relaxation in antiferromagnetic Kuramoto lattices](https://arxiv.org/abs/2607.15911)
...
### [99] [Nonequilibrium thermodynamics of feedback-control: a phase-space perspective](https://arxiv.org/abs/2607.16186)
