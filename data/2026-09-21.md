...
### [16] [Semiclassical Arrhenius law for quantum-thermal escape rates](https://arxiv.org/abs/2609.21625)
...
### [18] [Commutator Geometry and Information Preservation in the Quantum Switch](https://arxiv.org/abs/2609.21310)
*Xu Chen,Xue Ma*
...
### [19] [Weighted Berry curvature and global geometry of mixed quantum states](https://arxiv.org/abs/2609.21355)
...
### [20] [Floquet physics from quantized light-matter interaction: geometric phases, gauge consistency, and entanglement](https://arxiv.org/abs/2609.21741)
...
### [48] [Metallic Néel order stabilized by coupling between inequivalent Hubbard layers](https://arxiv.org/abs/2609.20922)
...
### [49] [Smectic Superconductivity](https://arxiv.org/abs/2609.20932)
...
### [50] [Digital-analog concept for superconducting perceptron-like neural networks](https://arxiv.org/abs/2609.21613)
...
### [51] [Collective excitation-mediated transport in nanoscale Josephson junctions that exhibit quantum confinement](https://arxiv.org/abs/2609.21725)
...
### [52] [Universal Dzyaloshinski-Moriya interaction dictates pairing in unconventional superconductor families](https://arxiv.org/abs/2609.21731)
...
### [53] [Topological properties and gap structure of the paired state in twisted TMD bilayers within a two-band effective model](https://arxiv.org/abs/2609.21825)
...
### [54] [Failure of Conventional Roughness Metrics in Assessing Field-Limiting Mesoscopic Topography in SRF Nb Films on Cu](https://arxiv.org/abs/2609.21835)
...
### [55] [Strong-coupling multigap superconductivity in the Heusler compound ScAu$_2$Al](https://arxiv.org/abs/2609.21845)
...
### [56] [Tunneling Spectroscopy Study of Low Baked Bulk Niobium for Superconducting RF Cavity Applications](https://arxiv.org/abs/2609.21865)
...
### [57] [Critical and near-critical influence bounds for ferromagnetic Ising models](https://arxiv.org/abs/2609.20866)
*Yan Ru Pei*
...
### [58] [A Functorial Theory of Defects in Abelian Chern-Simons Theory](https://arxiv.org/abs/2609.21414)
*Daniel Galviz*
...
### [59] [Gradient nature of Laplacian growth](https://arxiv.org/abs/2609.21430)
*A. Zabrodin*
...
### [60] [Entanglement-Inducing Quantum Markov Processes](https://arxiv.org/abs/2609.21438)
*J. Fransson,A. P. Sowa*
...
### [61] [Generalized Hamiltonian formalism for spatially nonlocal nonlinear differential equations](https://arxiv.org/abs/2609.22066)
...
### [62] [Deformation-induced amorphous complexion transitions elevate strength and ductility](https://arxiv.org/abs/2609.20908)
...
### [63] [Faulted loop nucleation and dopant activation in Al-implanted 4H-SiC](https://arxiv.org/abs/2609.20986)
...
### [64] [Dual-Sublattice Ferromagnetism Driven by Cooperative Double Exchange and Superexchange at NdNiO$_3$/CaMnO$_3$ Interfaces](https://arxiv.org/abs/2609.21002)
...
### [65] [Mechanism of charge transfer and electrostatic field fluctuations in complex metallic alloys](https://arxiv.org/abs/2609.21065)
...
### [66] [Polymer-free Assembly of Unencapsulated van der Waals Heterostructure Devices](https://arxiv.org/abs/2609.21120)
...
### [67] [Adaptive Mesh Coarsening for Efficient Phase-Field Fracture Simulations](https://arxiv.org/abs/2609.21201)
...
### [68] [The Critical Role of Itinerant Contributions to Orbital Angular Momentum Relaxation and Dynamics](https://arxiv.org/abs/2609.21300)
...
### [69] [Strain-Induced Relaxor Multiferroicity at Room Temperature in Hexaferrite BaFe12O19 Thin Films](https://arxiv.org/abs/2609.21352)
...
### [70] [Single Best Fits Can Be Misleading: Resolving Common Trapping Signatures across FA--Cs Perovskites](https://arxiv.org/abs/2609.21545)
...
### [71] [Orbital angular momentum accumulation in SrVO3 thin films](https://arxiv.org/abs/2609.21551)
...
### [72] [Validation of an Ab Initio-Informed Electronic Stopping Model for Large-Scale Atomistic Simulations](https://arxiv.org/abs/2609.21559)
...
### [73] [Material chemical compositon impacts on the band alignments: Preliminary results on the 3D/2D perovskite interfaces](https://arxiv.org/abs/2609.21654)
*Philippe Baranek*
...
### [74] [Adsorption of Phosgene Gas on Pristine and Noble Metal-Doped B12N12 Nanocages: Insights from Density Functional Theory](https://arxiv.org/abs/2609.21678)
...
### [75] [Complete Neural Electronic Initialization Accelerates Materials DFT](https://arxiv.org/abs/2609.21759)
...
### [76] [Electrodeposited Co and Ni Hexacyanoferrates: Insights into Structure and Morphology](https://arxiv.org/abs/2609.21819)
...
### [77] [Multivalley 3D Electronic Structure of PbSe from Soft-X-Ray ARPES and First-Principles Calculations](https://arxiv.org/abs/2609.21824)
...
### [78] [PhonoMC: Occupation-based deviational Monte Carlo for phonon transport with temperature-dependent scattering](https://arxiv.org/abs/2609.21884)
...
### [79] [Low resistance NiO/β-Ga_{2}O_{3} heterojunction diodes grown via molecular beam epitaxy](https://arxiv.org/abs/2609.21901)
...
### [80] [PAOFLOW: an automated suite for ab initio electronic, transport, and topological properties of materials](https://arxiv.org/abs/2609.21984)
...
### [81] [Insights into the long-standing controversy over sound velocities in lizardite](https://arxiv.org/abs/2609.22009)
...
### [82] [Symmetry Classification of Multipolar Orders in Crystals: Theory, Property Tensors and Automated Analysis with MagSymMultipoles](https://arxiv.org/abs/2609.22030)
...
### [83] [Pressure and Proximity Tuned Twisted Bilayer Graphene](https://arxiv.org/abs/2609.20958)
...
### [84] [Singular high-harmonic transport above a quantum threshold](https://arxiv.org/abs/2609.20990)
...
### [85] [Bend Contour Electron Tomography (BCET): Quantitative strain and topography mapping](https://arxiv.org/abs/2609.21041)
...
### [86] [Defect-mediated orientational ordering in stripe-forming magnetic systems](https://arxiv.org/abs/2609.21091)
...
### [87] [Projective representation theory of spin space groups](https://arxiv.org/abs/2609.21289)
...
### [88] [Rydberg excitons in core-shell nanostructures I. Optical properties](https://arxiv.org/abs/2609.21488)
...
### [89] [Floquet-spin-orbit compensation and flat- and quadratic-band contact in the $α$-$T_3$ lattice](https://arxiv.org/abs/2609.21586)
...
### [90] [Transport statistics and thermoelectric performance of Hofstadters butterfly](https://arxiv.org/abs/2609.21588)
...
### [91] [Spatially resolved quantum magnetometry and stray-field reconstruction of permalloy microdisks using boron-vacancy centers in hexagonal boron nitride](https://arxiv.org/abs/2609.21630)
...
### [92] [Field-free and Sub-ns Magnetization Reversal in Synthetic Anti-ferromagnets using Sequential Spin-Orbit Torque and Spin-Transfer Torque Pulses](https://arxiv.org/abs/2609.21669)
...
### [93] [Impact of exciton-phonon and exciton-magnon interaction on transport in anisotropic 2D magnetic semiconductors](https://arxiv.org/abs/2609.21746)
...
### [94] [Photogalvanic effect in monolayers of transition metal dichalcogenides](https://arxiv.org/abs/2609.22001)
...
### [95] [Non-Hermitian impurity scattering in graphene: Boltzmann transport and thermoelectric response](https://arxiv.org/abs/2609.22023)
...
### [96] [Bootstrapping Disordered Quantum Systems](https://arxiv.org/abs/2609.20916)
...
### [97] [Shape Deformation and Braid Statistics of Fractional Quantum Hall Quasiparticles](https://arxiv.org/abs/2609.20985)
...
### [98] [Resonant spin mode from retarded relaxation](https://arxiv.org/abs/2609.21623)
*J. Beater,G. S. Uhrig*
...
### [99] [Reformulating Pfaffian Quantum Monte Carlo with the Hybrid Monte Carlo formalism](https://arxiv.org/abs/2609.21631)
...
### [100] [Orbital character and photoemission signatures of the A-pocket in infinite-layer nickelates](https://arxiv.org/abs/2609.21665)
...
### [101] [Machine learning magnetic interactions from neutron powder diffraction data](https://arxiv.org/abs/2609.21970)
...
### [102] [Unified Field Bosonization Technique for strongly inhomogenous Luttinger Liquids](https://arxiv.org/abs/2609.21973)
...
### [103] [Correlation enhanced magnetism at a superconducting cuprate/manganite interface](https://arxiv.org/abs/2609.22051)
...
### [104] [Engineering Weak Universality with Quantum Dots](https://arxiv.org/abs/2609.20755)
...
### [105] [Bootstrapping Classical Systems with Quenched Disorder](https://arxiv.org/abs/2609.20927)
...
### [106] [Arctic Curves and a Gapped Gas Phase in a Two-Band Free-Fermion Chain](https://arxiv.org/abs/2609.21004)
...
### [107] [Functional Renormalization for Random Matrix Theory: The relational background field method](https://arxiv.org/abs/2609.21031)
...
### [108] [Persistence, resetting, and first-passage times of an active Ornstein--Uhlenbeck particle](https://arxiv.org/abs/2609.21124)
...
### [109] [The charge dependent hard-sphere model: Polycrystals as low-energy configurations](https://arxiv.org/abs/2609.21508)
...
### [110] [Local Detailed Balance in the Lorenz Model: Replaces the Butterfly with Frenetic Bursting](https://arxiv.org/abs/2609.21415)
...
### [111] [Full macroscopic thermalization and the formation of Schrödinger's cats by unitary time evolution in the weakly perturbed Ising model - Applications of the Roos-Sugimoto-Teufel-Tumulka-Vogel theory](https://arxiv.org/abs/2609.21757)
*Hal Tasaki*
...
### [112] [Self-avoiding trails in two and three dimensions](https://arxiv.org/abs/2609.21724)
...
### [113] [Non-negative differential mobility of one-dimensional underdamped Langevin dynamics: Proof via mapping to a marginally stable oscillator](https://arxiv.org/abs/2609.21833)
*Udo Seifert*
...
### [114] [Multi-Resolution Wire-Fencing for Efficient Path Sampling](https://arxiv.org/abs/2609.21897)
...
### [115] [Universal Eigenvector Statistics of Non-Hermitian Random Matrices](https://arxiv.org/abs/2609.22079)
